...
def crash():
    message_display("CRASHED", ((width * 0.5), (height * 0.5)),115)
    time.sleep(1)
    run()
...
def run():
    ...
    while not game_over:
        ...
        thing1(thing1_start_x, thing1_start_y, thing1_width, thing1_height, red)
        thing1_start_y += thing_speed
        thing1_start_x += (thing_speed * [-1, 1][random.randrange(2)])

        if score > 4:
            thing2(thing2_start_x, thing2_start_y, thing2_width, thing2_height, blue)
